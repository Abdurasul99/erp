...
app.post('/api/ai/suggest', auth(AI_ROLES), async (req, res) => {
  try {
    ...
    const prompt = (lang === 'uz'
      ? "Avvalgi javob asosida chakana biznes egasi nomidan 3 ta qisqa follow-up savol taklif qil. Savollar O'zbek tilida, lotin alifbosida bo'lsin. "
      : 'На основе предыдущего ответа предложи 3 коротких follow-up вопроса от лица владельца розничного бизнеса. ')
