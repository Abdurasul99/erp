  ...
  return (
    <>
      ...
      <div className="grid-4" style={{ marginBottom: 18 }}>
        <Tile icon="⭐" label="NPS" value="64" sub="Excellent (>50)" delta={9} color="#16A34A" />
        <Tile icon="😊" label={tt('Промоутеры')} value="72%" color="#16A34A" />
        <Tile icon="😐" label={tt('Нейтралы')} value="20%" color="#D97706" />
        <Tile icon="😠" label={tt('Детракторы')} value="8%" color="#DC2626" />
      </div>
      <div className="grid-2">
        <Card icon="📈" title={tt('Динамика NPS')}>
          <Sparkline data={[42, 48, 51, 55, 58, 62, 64]} color="#16A34A" />
        </Card>
