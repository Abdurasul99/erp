...
const CHANNELS = [
  ...
  { n: 'Google Ads', leads: 48, cpl: 24000, conv: 6, roi: 1.8, c: '#16A34A' },
  { n: 'SEO органика', leads: 76, cpl: 0, conv: 11, roi: 999, c: '#1D4ED8' },
  { n: 'Реф. программа', leads: 38, cpl: 5000, conv: 22, roi: 8.4, c: '#D97706' },
  { n: 'Партнёры', leads: 22, cpl: 0, conv: 18, roi: 999, c: '#D97706' },
];
  ...
  return (
    <>
      ...
      <div className="grid-4" style={{ marginBottom: 18 }}>
        <Tile icon="📥" label={tt('Лидов (мес)')} value="410" delta={28} color="#1D4ED8" />
        <Tile icon="💰" label={tt('Средний CPL')} value="9 200" color="#D97706" />
        <Tile icon="🎯" label={tt('В сделку')} value="11.8%" delta={3} color="#16A34A" />
