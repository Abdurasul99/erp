...
export const OWNER_UZ = {
  ...
  // BHI — индекс здоровья бизнеса
  'баллов': 'ball', 'vs вчера': 'kechagiga', 'за месяц': 'oy boshidan',
  'Адаптивный режим': 'Adaptiv rejim', 'Точность': 'Aniqlik', 'Активных блоков': 'Faol bloklar',
  'Вес выручки': 'Tushum vazni', 'Лучший день': 'Eng yaxshi kun', 'Худший день': 'Eng yomon kun',
  'вес': 'vazn', 'Уровень 2 — 8 блоков': '2-daraja — 8 blok', 'прокси': 'proksi', 'частично': 'qisman', 'реальные': 'haqiqiy',
  'Цель': 'Maqsad', 'Нет данных': "Ma'lumot yo'q",
  'История BHI накапливается — данные появятся в ближайшие дни': "BHI tarixi to'planmoqda — ma'lumotlar yaqin kunlarda paydo bo'ladi",
  'BHI считается по доступным данным — точность растёт со временем': "BHI mavjud ma'lumotlar bo'yicha hisoblanadi — aniqlik vaqt o'tishi bilan oshadi",
  'Норма': 'Norma', 'Внимание': 'Diqqat', 'Критично': 'Kritik',
  'Базовая': 'Bazaviy', 'Средняя': "O'rtacha", 'Полная': "To'liq",
  'Финансы': 'Moliya', 'Операции': 'Operatsiyalar', 'Люди': 'Jamoa', 'Рынок': 'Bozor',
  'Зарабатываем?': 'Daromad bormi?', 'Эффективны?': 'Samaralimi?', 'Команда?': 'Jamoa joyidami?', 'Растём?': "O'smoqdamizmi?",
  'Выручка': 'Tushum', 'Прибыльность': 'Foydalilik', 'Ликвидность': 'Likvidlik', 'Риск': 'Risk',
  'Снабжение': "Ta'minot", 'Активность команды': 'Jamoa faolligi', 'Клиенты': 'Mijozlar',
  'Цель BHI': 'BHI maqsadi', 'Режим цели': 'Maqsad rejimi', 'Авто': 'Avto', 'Ручной': "Qo'lda",
  'Целевой балл': 'Maqsadli ball', 'Сейчас цель': 'Hozirgi maqsad', 'Тип бизнеса': 'Biznes turi',
  'Розница': 'Chakana', 'Опт': 'Optom', 'Сохранение…': 'Saqlanmoqda…', 'Сохранить': 'Saqlash',
  'Цель сохранена': 'Maqsad saqlandi',
  'Авто: пока компании меньше 90 дней — отраслевой бенчмарк; дальше — среднее прошлого месяца ×1.05.': "Avto: kompaniya 90 kundan kichik bo'lsa — soha benchmarki; keyin — o'tgan oy o'rtachasi ×1.05.",
